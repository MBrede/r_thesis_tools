...
Zu dieser Art der Suche wurden in der Umfrage die in @fig-fstQuestion zusehenden groben Antwort-Kategorien angegeben.
...
3. **Datenbanken**: Hiermit sind die gängigen Datenbanken zur Suche von Literatur gemeint, in @tbl-dbs findet Ihr eine (nicht vollständige) Übersicht über Datenbanken und andere Quellen. Bei grober Themen-Suche muss aber darauf geachtet werden, dass je nach Datenbank nicht unbedingt Synonyme mit gesucht werden.
...
Je nach Datenbank wird eine Auswahl an logischen Operatoren zugelassen, für eine Anleitung zu effektiven Suchstrategien ist die [Anleitung zu Pubmed von der Johns Hopkins Universität](https://browse.welch.jhmi.edu/searching/pubmed-search-tips) ganz gut. Die Anleitung hat viele PubmMed-spezifische Punkte, die Teile 4,5 und 6 haben aber auch gute Hinweise, die sich auf andere Datenbanken generalisieren lassen.
...
Und ein Tool genannt, das ich zumindest nicht kannte:
...
Zu dem Item in der Umfrage waren besonders die folgende Antwort sehr interessant:
