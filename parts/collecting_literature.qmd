...
Google Scholar, Researchgate, Website der Publisher, "Andere", Autor*innen kontaktieren
...
Google Scholar, Researchgate
Researchgate, "Andere"
Google Scholar, Researchgate, Universitätsbibliothek
Google Scholar, Researchgate, Von Doz. vorgegebene Literatur') |> 
  parse_mentions_list(2024)

answers25 <- ('Google Scholar, Website der Publisher, "Andere"
Google Scholar, Hogrefe eContent 
Google Scholar, Researchgate
Google Scholar, Website der Publisher
Researchgate
Google Scholar, Researchgate
Google Scholar
Google Scholar, "Andere"
Google Scholar, Researchgate, Website der Publisher, Autor*innen kontaktieren') |> 
...
4. **Autor*innen kontaktieren**: Zuletzt funktioniert es oft, dem Kontaktautoren eine Email zu schreiben. Mit der Veröffentlichung erhalten Autor:innen bei vielen Journals eine PDF, die sie oft gern weitergeben. Über Researchgate lässt sich eine derartige Anfrage übrigens auch stellen.
...
In dieser Kohorte nutzen das erste mal alle Studis Literaturverwaltungsprogramme. Ich bin stolz auf Euch! Die folgenden Vorteile sind Euch damit ja wahrscheinlich auch bekannt:
