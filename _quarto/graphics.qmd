...
1. Lese den [im Repo zu diesem Skript](https://raw.githubusercontent.com/MBrede/r_thesis_tools/main/data/example.csv) zur Verfügung gestellten Datensatz `example.csv` ein.
