...
Wir wollen den Zusammenhang zwischen Körpergewicht und Schnabellänge über die Spezien betrachten. 
...
1. Lese den [im Repo zu diesem Skript](https://github.com/MBrede/r_thesis_tools/data) zur Verfügung gestellten Datensatz `all_data.csv` ein.

2. Stelle die Reaktionszeiten und Accuracies in einem Scatterplot dar.

3. Färbe den Graphen nach Gruppen ein

4. Füge Mittelwerte und Standardabweichungen hinzu. Füge die Standardabweichungen dabei mit `geom_linerange` in zwei layern hinzu (einem für die x- und einem für die y-Richtung)
