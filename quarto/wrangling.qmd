...
![Pinguin im Kampf mit vielen Ordnern](../imgs/penguin_wrestling_files.png)
...
Für jeden Probanden wird dabei eine Datei erstellt, so dass der data-folder gerne mal wie in Abb. @fig-folder aussehen kann.
...
Im ersten Fall habt Ihr ganz andere Probleme und solltet im Detail darüber nachdenken wie ihr das löst - oder den manuellen Weg wählen.
Im zweiten Fall könnt Ihr alle zu kleinen files einfach filtern:
